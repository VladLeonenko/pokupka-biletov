...
// КАСТОМНЫЙ КУРСОР ПЕРЕВЕДЁН В REACT (useCursor).
// Оставляем только стили из CSS (.cursor--large/.cursor--small), а логика движения
// реализована в frontend/src/hooks/useCursor.ts. Здесь курсор больше не инициализируем.




// Owl Carousel удален - используем нативные карусели через data-carousel
// Карусели инициализируются автоматически через native-carousel.js
(function() {
  ...
  const nonloop = document.querySelector('.nonloop');
  if (nonloop && !nonloop.hasAttribute('data-carousel')) {
    nonloop.setAttribute('data-carousel', 'blog-nonloop');
  }
})();
// Старый код owlCarousel удален - используем нативные карусели
// Убеждаемся, что data-carousel атрибуты установлены для всех каруселей
(function() {
  const menuNav = document.querySelector('.menu-nav');
  if (menuNav && !menuNav.hasAttribute('data-carousel')) {
    menuNav.setAttribute('data-carousel', 'menu-nav');
  }
  
  const team = document.querySelector('.team');
  if (team && !team.hasAttribute('data-carousel')) {
    team.setAttribute('data-carousel', 'team');
  }
  
  const casesTeam = document.querySelector('.cases-team');
  if (casesTeam && !casesTeam.hasAttribute('data-carousel')) {
    casesTeam.setAttribute('data-carousel', 'cases-team');
  }
  
  const adsTeam = document.querySelector('.ads-team');
  if (adsTeam && !adsTeam.hasAttribute('data-carousel')) {
    adsTeam.setAttribute('data-carousel', 'ads-team');
  }
})();
/* Старый код owlCarousel удален - весь код закомментирован */

// Slick carousel удален - используем нативные карусели через data-carousel
// Карусели инициализируются автоматически через native-carousel.js
$(function(){
    // Убеждаемся, что data-carousel атрибут установлен для вертикальной карусели
    const verticalCarousel = document.querySelector('.vertical-carousel');
    if (verticalCarousel && !verticalCarousel.hasAttribute('data-carousel')) {
      verticalCarousel.setAttribute('data-carousel', 'main-vertical-carousel');
    }
    // Старый код slick удален
    $slideshow = null; // Для совместимости со старым кодом
  });
...
$(document).ready(function(){
    $(".design-order").click(function(){
        $("#design-popup").toggleClass('show_popup'); 
    });
    $(".website-order").click(function(){
        $("#popup").toggleClass('show_popup'); 
    });
   
    $(".seo-order").click(function(){
        $("#seo-popup").toggleClass('show_popup'); 
    });
    $(".mobile-order").click(function(){
        $("#mobile-popup").toggleClass('show_popup'); 
    });
    $(".closePopup").click(function(){
        $("#popup").removeClass('show_popup'); 
        $("#mobile-popup").removeClass('show_popup'); 
        $("#seo-popup").removeClass('show_popup'); 
        $("#design-popup").removeClass('show_popup'); 
