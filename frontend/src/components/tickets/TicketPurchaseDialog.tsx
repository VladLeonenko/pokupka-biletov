    ...
    >
      ...
      <DialogContent className={styles.body}>
        ...
        <p className={styles.legal}>
          Далее откроется защищённая страница <strong>Т-Банка</strong>. До оплаты бронь только у нас и на почте; у оператора места закрепятся после оплаты. После успешной оплаты мы пришлём письмо с
