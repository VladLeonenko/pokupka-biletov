import { Box, Typography, Button, Grid, Card, CardContent, Accordion, AccordionSummary, AccordionDetails, TextField, Chip } from '@mui/material';
        ...
        <Box sx={{ py: 4 }}>
          ...
          <Typography
            ...
            dangerouslySetInnerHTML={{
              __html: block.content?.text || block.content?.html || 'Содержимое текстового блока.',
            }}
          />
        </Box>
      );
