        ...
        <Paper elevation={3} sx={{ p: { xs: 3, md: 6 }, borderRadius: 2 }}>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              Настоящая Политика конфиденциальности (далее — «Политика») определяет порядок обработки и защиты персональных данных пользователей веб-сайта <strong>primecoder.ru</strong> (далее — «Сайт»), принадлежащего ИП Леоненко Владислава, действующему на основании ОГРНИП 319402700056528, ИНН 771896554467 (далее — «Оператор», «Мы», «Нас»).
            </Typography>
            <Typography variant="body1" paragraph>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <List>
              <ListItem>
                <ListItemText
                  primary="Оператор"
                  secondary="ИП Леоненко Владислава, действующий на основании ОГРНИП 319402700056528, ИНН 771896554467, организующий и (или) осуществляющий обработку персональных данных, а также определяющий цели обработки персональных данных, состав персональных данных, подлежащих обработке, действия (операции), совершаемые с персональными данными."
                />
              </ListItem>
              <ListItem>
                <ListItemText
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph sx={{ mt: 2 }}>
              Для реализации указанных прав Пользователь может направить запрос Оператору по адресу электронной почты: <strong>info@prime-coder.ru</strong> или почтовому адресу, указанному в разделе «Контакты».
            </Typography>
            <Typography variant="body1" paragraph>
            ...
            <List>
              <ListItem>
                <ListItemText
                  ...
                  secondary="ИП Леоненко Владислава, действующий на основании ОГРНИП 319402700056528, ИНН 771896554467"
                />
              </ListItem>
              <ListItem>
                <ListItemText
                  primary="Электронная почта:"
                  secondary={<strong>info@prime-coder.ru</strong>}
                />
              </ListItem>
              <ListItem>
                <ListItemText
                  primary="Телефон:"
                  secondary="+7 (999) 984-91-07"
                />
              </ListItem>
              <ListItem>
                <ListItemText
