...
export function AboutPage() {
  ...
  return (
    <>
      <SeoMetaTags
        title="О нас — PrimeCoder: команда, ценности, маркетплейс digital-услуг"
        description="PrimeCoder — маркетплейс digital-услуг и веб-студия. Команда профессионалов, разработка сайтов, SEO, реклама у блогеров. Участие в благотворительности. Более 150 проектов."
        keywords="о компании PrimeCoder, веб-студия, команда, маркетплейс digital-услуг, благотворительность, разработка сайтов, Москва"
        url={currentUrl}
