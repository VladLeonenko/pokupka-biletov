...
export function TechnicalAuditPage() {
  ...
  return (
    <>
      <SeoMetaTags
        title="Бесплатный технический аудит сайта — SEO"
        description="Проверьте сайт: скорость загрузки, мобильная адаптация, ошибки. Получите отчёт с рекомендациями. За 2 минуты."
        keywords="технический аудит сайта, SEO аудит, проверка скорости сайта, мобильная версия"
        url={currentUrl}
      />
