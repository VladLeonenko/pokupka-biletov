  ...
  return (
    <Box>
      ...
      <Alert severity="info" sx={{ mb: 2 }}>
        Свои места (AgentId кабинета = GETBILET_USER_ID): с процентной наценки снимаем 25{' '}
        <strong>пунктов</strong>. Если глобально 70%, свои продаются с 45% (70 − 25). Это не «на 25% меньше
        наценки»: 70 × 0,75 = 52,5% — так не считаем. Если чужой на том же месте всё ещё дешевле, цена
        своих мест автоматически опускается, пока не станет самой низкой (с полом закуп + 5%).
      </Alert>
