#!/bin/bash
# Скрипт для создания create-initial-quiz.js на сервере
# Выполнить на сервере: bash CREATE_QUIZ_SCRIPT_ON_SERVER.sh

cat > /var/www/primecoder-gulp/backend/scripts/create-initial-quiz.js << 'SCRIPT_EOF'
#!/usr/bin/env node
/**
...
chmod +x /var/www/primecoder-gulp/backend/scripts/create-initial-quiz.js
echo "✅ Файл создан: /var/www/primecoder-gulp/backend/scripts/create-initial-quiz.js"
