...
COMMENT ON TABLE getbilet_competitor_price_daily IS
  'Дневной срез цен агентов GetBilet по репертуару/сеансу; розница — как на нашей витрине до подрезки';
COMMENT ON TABLE getbilet_competitor_event_daily IS
  'Сводка: свои vs самый дешёвый конкурент, где проигрываем до подрезки';
