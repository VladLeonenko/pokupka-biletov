...
import luzhnikiConcertHallSeatEditorRouter from './routes/luzhnikiConcertHallSeatEditor.js';
...
app.use('/api/tools/luzhniki-concert-seats', luzhnikiConcertHallSeatEditorRouter);
